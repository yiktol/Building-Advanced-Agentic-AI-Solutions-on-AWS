"""
Run all Module 2 tests sequentially with a final summary.
...
TESTS = [
    ("Part 1: Context Exhaustion", "tests/test_part1.py"),
    ("Part 2: Prompt Caching", "tests/test_part2.py"),
    ("Part 3: Conversation Managers", "tests/test_part3.py"),
    ("Part 4: Context Isolation", "tests/test_part4.py"),
    ("Part 5: Tool Design", "tests/test_part5.py"),
]


def main():
    print(f"\n{HEADER_BG}{'=' * 72}{RESET}")
    print(f"{HEADER_BG}  MODULE 2 — RUN ALL TESTS                                            {RESET}")
